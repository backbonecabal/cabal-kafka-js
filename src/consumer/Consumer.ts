...
export class Consumer extends KafkaClient {
  ...
  constructor(
    ...
    super({ clientId: 'backbonecabal-client-consumer', ...kafkaConfig, brokers })
    this.topics = topics

    this.consumer = this.kafka.consumer({ groupId: 'backbonecabal-client-consumer', ...consumerConfig })
  }
